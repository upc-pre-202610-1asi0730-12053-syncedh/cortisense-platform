...
namespace SyncedHealth.Center.Platform.Migrations
{
    ...
    [Migration("20260704173655_SeedInitialData")]
            ...
            modelBuilder.Entity("SyncedHealth.Center.Platform.ClinicalRiskAssessment.Domain.Model.Aggregates.RiskAssessment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HeartRate = 120,
                            Hrv = 20,
                            LastUpdatedAt = new DateTimeOffset(new DateTime(2026, 7, 4, 17, 36, 53, 141, DateTimeKind.Unspecified).AddTicks(4165), new TimeSpan(0, 0, 0, 0, 0)),
                            OrganizationId = 101,
                            RiskLevel = "HIGH",
                            UserId = 103
                        },
                        new
                        {
                            ...
                            HeartRate = 70,
                            Hrv = 60,
                            LastUpdatedAt = new DateTimeOffset(new DateTime(2026, 7, 4, 17, 36, 53, 141, DateTimeKind.Unspecified).AddTicks(5935), new TimeSpan(0, 0, 0, 0, 0)),
                            OrganizationId = 101,
                            RiskLevel = "LOW",
                            UserId = 104
                        });
            ...
            modelBuilder.Entity("SyncedHealth.Center.Platform.ShiftCoordination.Domain.Model.Aggregates.ShiftRecord", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 101,
                            OrganizationId = 101,
                            ScheduledEnd = new DateTimeOffset(new DateTime(2026, 7, 6, 1, 36, 53, 140, DateTimeKind.Unspecified).AddTicks(8351), new TimeSpan(0, 0, 0, 0, 0)),
                            ScheduledStart = new DateTimeOffset(new DateTime(2026, 7, 5, 17, 36, 53, 140, DateTimeKind.Unspecified).AddTicks(8082), new TimeSpan(0, 0, 0, 0, 0)),
                            Status = "SCHEDULED",
                            Type = "DAY",
                            UserId = 103,
                            WorkAreaId = 101
                        ...
                        new
                        {
                            Id = 102,
                            OrganizationId = 101,
                            ScheduledEnd = new DateTimeOffset(new DateTime(2026, 7, 6, 21, 36, 53, 140, DateTimeKind.Unspecified).AddTicks(9851), new TimeSpan(0, 0, 0, 0, 0)),
                            ScheduledStart = new DateTimeOffset(new DateTime(2026, 7, 6, 13, 36, 53, 140, DateTimeKind.Unspecified).AddTicks(9845), new TimeSpan(0, 0, 0, 0, 0)),
                            Status = "SCHEDULED",
                            Type = "NIGHT",
                            UserId = 104,
                            WorkAreaId = 101
                        ...
                        {
                            Id = 103,
                            CheckInAt = new DateTimeOffset(new DateTime(2026, 7, 4, 7, 36, 53, 140, DateTimeKind.Unspecified).AddTicks(9854), new TimeSpan(0, 0, 0, 0, 0)),
                            OrganizationId = 101,
                            ScheduledEnd = new DateTimeOffset(new DateTime(2026, 7, 4, 19, 36, 53, 140, DateTimeKind.Unspecified).AddTicks(9853), new TimeSpan(0, 0, 0, 0, 0)),
                            ScheduledStart = new DateTimeOffset(new DateTime(2026, 7, 4, 7, 36, 53, 140, DateTimeKind.Unspecified).AddTicks(9853), new TimeSpan(0, 0, 0, 0, 0)),
                            Status = "IN_PROGRESS",
                            Type = "EMERGENCY",
                            UserId = 103,
                            WorkAreaId = 102
            ...
            modelBuilder.Entity("SyncedHealth.Center.Platform.Subscription.Domain.Model.Aggregates.Subscription", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            OrganizationId = 101,
                            PlanId = 102,
                            StartedAt = new DateTimeOffset(new DateTime(2026, 7, 4, 17, 36, 53, 140, DateTimeKind.Unspecified).AddTicks(6413), new TimeSpan(0, 0, 0, 0, 0)),
                            Status = "Active"
                        });
                });
