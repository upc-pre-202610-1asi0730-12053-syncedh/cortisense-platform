...
namespace SyncedHealth.Center.Platform.Migrations
{
    ...
    [Migration("20260706195533_FixDynamicSeedDates")]
    partial class FixDynamicSeedDates
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SyncedHealth.Center.Platform.ClinicalRiskAssessment.Domain.Model.Aggregates.RiskAssessment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HeartRate = 120,
                            Hrv = 20,
                            LastUpdatedAt = new DateTimeOffset(new DateTime(2026, 7, 6, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            OrganizationId = 101,
                            RiskLevel = "HIGH",
                            UserId = 103
                        },
            ...
            modelBuilder.Entity("SyncedHealth.Center.Platform.ShiftCoordination.Domain.Model.Aggregates.ShiftRecord", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 101,
                            OrganizationId = 101,
                            ScheduledEnd = new DateTimeOffset(new DateTime(2026, 7, 7, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            ScheduledStart = new DateTimeOffset(new DateTime(2026, 7, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Status = "SCHEDULED",
                            Type = "DAY",
                            UserId = 103,
                            WorkAreaId = 2
                        ...
                        new
                        {
                            Id = 102,
                            OrganizationId = 101,
                            ScheduledEnd = new DateTimeOffset(new DateTime(2026, 7, 8, 4, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            ScheduledStart = new DateTimeOffset(new DateTime(2026, 7, 7, 20, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Status = "SCHEDULED",
                            Type = "NIGHT",
                            UserId = 104,
                            WorkAreaId = 1
                        ...
                        {
                            Id = 103,
                            CheckInAt = new DateTimeOffset(new DateTime(2026, 7, 5, 14, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            OrganizationId = 101,
                            ScheduledEnd = new DateTimeOffset(new DateTime(2026, 7, 6, 2, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            ScheduledStart = new DateTimeOffset(new DateTime(2026, 7, 5, 14, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Status = "IN_PROGRESS",
                            Type = "EMERGENCY",
                            UserId = 103,
                            WorkAreaId = 3
                        ...
                        {
                            Id = 204,
                            CheckInAt = new DateTimeOffset(new DateTime(2026, 7, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            CheckOutAt = new DateTimeOffset(new DateTime(2026, 7, 5, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            OrganizationId = 101,
                            ScheduledEnd = new DateTimeOffset(new DateTime(2026, 7, 5, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            ScheduledStart = new DateTimeOffset(new DateTime(2026, 7, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Status = "COMPLETED",
                            Type = "DAY",
                            UserId = 205,
                            WorkAreaId = 2
                        ...
                        new
                        {
                            Id = 205,
                            OrganizationId = 101,
                            ScheduledEnd = new DateTimeOffset(new DateTime(2026, 7, 8, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            ScheduledStart = new DateTimeOffset(new DateTime(2026, 7, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Status = "SCHEDULED",
                            Type = "DAY",
                            UserId = 206,
                            WorkAreaId = 1
            ...
            modelBuilder.Entity("SyncedHealth.Center.Platform.Subscription.Domain.Model.Aggregates.Subscription", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            OrganizationId = 101,
                            PlanId = 3,
                            StartedAt = new DateTimeOffset(new DateTime(2026, 7, 6, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Status = "Active"
                        });
                });
